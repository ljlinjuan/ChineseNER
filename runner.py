...
class Optimizer(StocksPortfolioOptimizer):
    ...
    def get_weights(self, expect_return):
        ...
        bench_index_weights = get_index_weights_on_factor_calculation_dates(self.universe, self.factor_calculation_dates, self.bench_index_name_or_weight_path)
        bench_index_weights = (bench_index_weights.T / bench_index_weights.sum(1).values).T.fillna(0).values
